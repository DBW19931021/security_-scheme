...
uint32_t oid_get_sig_alg(const mbedtls_asn1_buf *oid, mbedtls_md_type_t *md_alg, mbedtls_pk_type_t *pk_alg);

uint32_t oid_get_pk_alg(const mbedtls_asn1_buf *oid, mbedtls_pk_type_t *pk_alg);

uint32_t oid_get_numeric_string(char *buf, size_t size, const mbedtls_asn1_buf *oid);

uint32_t oid_get_md_alg(const mbedtls_asn1_buf *oid, cpt_hash_alg_e *md_alg);

uint32_t oid_get_ec_grp(const mbedtls_asn1_buf *oid, mbedtls_ecp_group_id *ec_grp_id);
#ifdef __cplusplus
}
#endif

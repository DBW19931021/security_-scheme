...
// #% #if CONFIG_EHSM_ALGO_PQC_ENABLE
/**
 * @brief 用于辅助 PQC ML-KEM-512 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_512 */
    uint8_t part_info;        /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];      /**< 保留 */
    uint16_t encaps_key_size; /**< 封装密钥长度，应为 800 */
    uint16_t decaps_key_size; /**< 解封密钥长度，应为 1648 */
    uint8_t encaps_key[800];  /**< 封装密钥的明文值，800 字节 */
    uint8_t decaps_key[1648]; /**< 解封密钥的密文值，有 PKCS7 填充，1648 字节 */
} ehsm_key_format_pqc_ml_kem_512_cipher_keypair_st;

/**
 * @brief 用于辅助 PQC ML-KEM-512 解封密钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_512 */
    uint8_t part_info;        /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];      /**< 保留 */
    uint16_t encaps_key_size; /**< 为 0 */
    uint16_t decaps_key_size; /**< 解封密钥长度，应为 1648 */
    uint8_t decaps_key[1648]; /**< 解封密钥的密文值，有 PKCS7 填充，1648 字节 */
} ehsm_key_format_pqc_ml_kem_512_cipher_decaps_key_st;

/**
 * @brief 用于辅助 PQC ML-KEM-512 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_512 */
    ...
    uint8_t reserved[2];      /**< 保留 */
    uint16_t encaps_key_size; /**< 封装密钥长度，应为 800 */
    uint16_t decaps_key_size; /**< 解封密钥长度，应为 1632 */
    uint8_t encaps_key[800];  /**< 封装密钥的明文值，800 字节 */
    uint8_t decaps_key[1632]; /**< 解封密钥的明文值，1632 字节 */
} ehsm_key_format_pqc_ml_kem_512_plain_keypair_st;

/**
 * @brief 用于辅助 PQC ML-KEM-512 封装密钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_512 */
    ...
    uint8_t reserved[2];      /**< 保留 */
    uint16_t encaps_key_size; /**< 封装密钥长度，应为 800 */
    uint16_t decaps_key_size; /**< 为 0 */
    uint8_t encaps_key[800];  /**< 封装密钥的明文值，800 字节 */
} ehsm_key_format_pqc_ml_kem_512_plain_encaps_key_st;

/**
 * @brief 用于辅助 PQC ML-KEM-512 解封密钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_512 */
    ...
    uint16_t decaps_key_size; /**< 解封密钥长度，应为 1632 */
    uint8_t decaps_key[1632]; /**< 解封密钥的明文值，1632 字节 */
} ehsm_key_format_pqc_ml_kem_512_plain_decaps_key_st;

/**
 * @brief 用于辅助 PQC ML-KEM-768 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_768 */
    uint8_t part_info;        /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];      /**< 保留 */
    uint16_t encaps_key_size; /**< 封装密钥长度，应为 1184 */
    uint16_t decaps_key_size; /**< 解封密钥长度，应为 2416 */
    uint8_t encaps_key[1184]; /**< 封装密钥的明文值，1184 字节 */
    uint8_t decaps_key[2416]; /**< 解封密钥的密文值，有 PKCS7 填充，2416 字节 */
} ehsm_key_format_pqc_ml_kem_768_cipher_keypair_st;

/**
 * @brief 用于辅助 PQC ML-KEM-768 解封密钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_768 */
    ...
    uint16_t decaps_key_size; /**< 解封密钥长度，应为 2416 */
    uint8_t decaps_key[2416]; /**< 解封密钥的密文值，有 PKCS7 填充，2416 字节 */
} ehsm_key_format_pqc_ml_kem_768_cipher_decaps_key_st;

/**
 * @brief 用于辅助 PQC ML-KEM-768 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_768 */
    ...
    uint8_t reserved[2];      /**< 保留 */
    uint16_t encaps_key_size; /**< 封装密钥长度，应为 1184 */
    uint16_t decaps_key_size; /**< 解封密钥长度，应为 2400 */
    uint8_t encaps_key[1184]; /**< 封装密钥的明文值，1184 字节 */
    uint8_t decaps_key[2400]; /**< 解封密钥的明文值，2400 字节 */
} ehsm_key_format_pqc_ml_kem_768_plain_keypair_st;

/**
 * @brief 用于辅助 PQC ML-KEM-768 封装密钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_768 */
    ...
    uint16_t decaps_key_size; /**< 为 0 */
    uint8_t encaps_key[1184]; /**< 封装密钥的明文值，1184 字节 */
} ehsm_key_format_pqc_ml_kem_768_plain_encaps_key_st;

/**
 * @brief 用于辅助 PQC ML-KEM-768 解封密钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_768 */
    ...
    uint16_t decaps_key_size; /**< 解封密钥长度，应为 2400 */
    uint8_t decaps_key[2400]; /**< 解封密钥的明文值，2400 字节 */
} ehsm_key_format_pqc_ml_kem_768_plain_decaps_key_st;

/**
 * @brief 用于辅助 PQC ML-KEM-1024 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_1024 */
    uint8_t part_info;        /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];      /**< 保留 */
    uint16_t encaps_key_size; /**< 封装密钥长度，应为 1568 */
    uint16_t decaps_key_size; /**< 解封密钥长度，应为 3184 */
    uint8_t encaps_key[1568]; /**< 封装密钥的明文值，1568 字节 */
    uint8_t decaps_key[3184]; /**< 解封密钥的密文值，有 PKCS7 填充，3184 字节 */
} ehsm_key_format_pqc_ml_kem_1024_cipher_keypair_st;

/**
 * @brief 用于辅助 PQC ML-KEM-1024 解封密钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_1024 */
    ...
    uint16_t decaps_key_size; /**< 解封密钥长度，应为 3184 */
    uint8_t decaps_key[3184]; /**< 解封密钥的密文值，有 PKCS7 填充，3184 字节 */
} ehsm_key_format_pqc_ml_kem_1024_cipher_decaps_key_st;

/**
 * @brief 用于辅助 PQC ML-KEM-1024 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_1024 */
    ...
    uint8_t reserved[2];      /**< 保留 */
    uint16_t encaps_key_size; /**< 封装密钥长度，应为 1568 */
    uint16_t decaps_key_size; /**< 解封密钥长度，应为 3168 */
    uint8_t encaps_key[1568]; /**< 封装密钥的明文值，1568 字节 */
    uint8_t decaps_key[3168]; /**< 解封密钥的明文值，3168 字节 */
} ehsm_key_format_pqc_ml_kem_1024_plain_keypair_st;

/**
 * @brief 用于辅助 PQC ML-KEM-1024 封装密钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_1024 */
    ...
    uint16_t decaps_key_size; /**< 为 0 */
    uint8_t encaps_key[1568]; /**< 封装密钥的明文值，1568 字节 */
} ehsm_key_format_pqc_ml_kem_1024_plain_encaps_key_st;

/**
 * @brief 用于辅助 PQC ML-KEM-1024 解封密钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;       /**< 权限位，见 @ref key-priv */
    uint8_t key_type;         /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_KEM_1024 */
    ...
    uint16_t decaps_key_size; /**< 解封密钥长度，应为 3168 */
    uint8_t decaps_key[3168]; /**< 解封密钥的明文值，3168 字节 */
} ehsm_key_format_pqc_ml_kem_1024_plain_decaps_key_st;

/**
 * @brief 用于辅助 PQC ML-DSA-44 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_44 */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 1312 */
    uint16_t privkey_size; /**< 私钥长度，应为 2576 */
    uint8_t pubkey[1312];  /**< 公钥的明文值，1312 字节 */
    uint8_t privkey[2576]; /**< 私钥的密文值，有 PKCS7 填充，2576 字节 */
} ehsm_key_format_pqc_ml_dsa_44_cipher_keypair_st;

/**
 * @brief 用于辅助 PQC ML-DSA-44 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_44 */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 为 0 */
    uint16_t privkey_size; /**< 私钥长度，应为 2576 */
    uint8_t privkey[2576]; /**< 私钥的密文值，有 PKCS7 填充，2576 字节 */
} ehsm_key_format_pqc_ml_dsa_44_cipher_privkey_key_st;

/**
 * @brief 用于辅助 PQC ML-DSA-44 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_44 */
    ...
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 1312 */
    uint16_t privkey_size; /**< 私钥长度，应为 2560 */
    uint8_t pubkey[1312];  /**< 公钥的明文值，1312 字节 */
    uint8_t privkey[2560]; /**< 私钥的明文值，2560 字节 */
} ehsm_key_format_pqc_ml_dsa_44_plain_keypair_st;

/**
 * @brief 用于辅助 PQC ML-DSA-44 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_44 */
    ...
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 1312 */
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[1312];  /**< 公钥的明文值，1312 字节 */
} ehsm_key_format_pqc_ml_dsa_44_plain_pubkey_key_st;

/**
 * @brief 用于辅助 PQC ML-DSA-44 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_44 */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 2560 */
    uint8_t privkey[2560]; /**< 私钥的明文值，2560 字节 */
} ehsm_key_format_pqc_ml_dsa_44_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC ML-DSA-65 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_65 */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 1952 */
    uint16_t privkey_size; /**< 私钥长度，应为 4048 */
    uint8_t pubkey[1952];  /**< 公钥的明文值，1952 字节 */
    uint8_t privkey[4048]; /**< 私钥的密文值，有 PKCS7 填充，4048 字节 */
} ehsm_key_format_pqc_ml_dsa_65_cipher_keypair_st;

/**
 * @brief 用于辅助 PQC ML-DSA-65 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_65 */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 4048 */
    uint8_t privkey[4048]; /**< 私钥的密文值，有 PKCS7 填充，4048 字节 */
} ehsm_key_format_pqc_ml_dsa_65_cipher_privkey_key_st;

/**
 * @brief 用于辅助 PQC ML-DSA-65 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_65 */
    ...
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 1952 */
    uint16_t privkey_size; /**< 私钥长度，应为 4032 */
    uint8_t pubkey[1952];  /**< 公钥的明文值，1952 字节 */
    uint8_t privkey[4032]; /**< 私钥的明文值，4032 字节 */
} ehsm_key_format_pqc_ml_dsa_65_plain_keypair_st;

/**
 * @brief 用于辅助 PQC ML-DSA-65 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_65 */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[1952];  /**< 公钥的明文值，1952 字节 */
} ehsm_key_format_pqc_ml_dsa_65_plain_pubkey_key_st;

/**
 * @brief 用于辅助 PQC ML-DSA-65 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_65 */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 4032 */
    uint8_t privkey[4032]; /**< 私钥的明文值，4032 字节 */
} ehsm_key_format_pqc_ml_dsa_65_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC ML-DSA-87 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_87 */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 2592 */
    uint16_t privkey_size; /**< 私钥长度，应为 4912 */
    uint8_t pubkey[2592];  /**< 公钥的明文值，2592 字节 */
    uint8_t privkey[4912]; /**< 私钥的密文值，有 PKCS7 填充，4912 字节 */
} ehsm_key_format_pqc_ml_dsa_87_cipher_keypair_st;

/**
 * @brief 用于辅助 PQC ML-DSA-87 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_87 */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 4912 */
    uint8_t privkey[4912]; /**< 私钥的密文值，有 PKCS7 填充，4912 字节 */
} ehsm_key_format_pqc_ml_dsa_87_cipher_privkey_key_st;

/**
 * @brief 用于辅助 PQC ML-DSA-87 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_87 */
    ...
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 2592 */
    uint16_t privkey_size; /**< 私钥长度，应为 4896 */
    uint8_t pubkey[2592];  /**< 公钥的明文值，2592 字节 */
    uint8_t privkey[4896]; /**< 私钥的明文值，4896 字节 */
} ehsm_key_format_pqc_ml_dsa_87_plain_keypair_st;

/**
 * @brief 用于辅助 PQC ML-DSA-87 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_87 */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[2592];  /**< 公钥的明文值，2592 字节 */
} ehsm_key_format_pqc_ml_dsa_87_plain_pubkey_key_st;

/**
 * @brief 用于辅助 PQC ML-DSA-87 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_ML_DSA_87 */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 4896 */
    uint8_t privkey[4896]; /**< 私钥的明文值，4896 字节 */
} ehsm_key_format_pqc_ml_dsa_87_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC SLH-DSA-SHA2-128S 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_128S */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 32 */
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t pubkey[32];    /**< 公钥的明文值，32 字节 */
    uint8_t privkey[48];   /**< 私钥的密文值，有 PKCS7 填充，48 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_128s_cipher_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-128S 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_128S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t privkey[48];   /**< 私钥的密文值，有 PKCS7 填充，48 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_128s_cipher_privkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-128S 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_128S */
    ...
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 32 */
    uint16_t privkey_size; /**< 私钥长度，应为 32 */
    uint8_t pubkey[32];    /**< 公钥的明文值，32 字节 */
    uint8_t privkey[32];   /**< 私钥的明文值，32 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_128s_plain_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-128S 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_128S */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[32];    /**< 公钥的明文值，32 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_128s_plain_pubkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-128S 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_128S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 32 */
    uint8_t privkey[32];   /**< 私钥的明文值，32 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_128s_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC SLH-DSA-SHAKE-128S 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_128S */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 32 */
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t pubkey[32];    /**< 公钥的明文值，32 字节 */
    uint8_t privkey[48];   /**< 私钥的密文值，有 PKCS7 填充，48 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_128s_cipher_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-128S 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_128S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t privkey[48];   /**< 私钥的密文值，有 PKCS7 填充，48 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_128s_cipher_privkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-128S 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_128S */
    ...
    uint8_t pubkey[32];    /**< 公钥的明文值，32 字节 */
    uint8_t privkey[32];   /**< 私钥的明文值，32 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_128s_plain_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-128S 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_128S */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[32];    /**< 公钥的明文值，32 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_128s_plain_pubkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-128S 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_128S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 32 */
    uint8_t privkey[32];   /**< 私钥的明文值，32 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_128s_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC SLH-DSA-SHA2-128F 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_128F */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 32 */
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t pubkey[32];    /**< 公钥的明文值，32 字节 */
    uint8_t privkey[48];   /**< 私钥的密文值，有 PKCS7 填充，48 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_128f_cipher_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-128F 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_128F */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t privkey[48];   /**< 私钥的密文值，有 PKCS7 填充，48 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_128f_cipher_privkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-128F 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_128F */
    ...
    uint8_t pubkey[32];    /**< 公钥的明文值，32 字节 */
    uint8_t privkey[32];   /**< 私钥的明文值，32 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_128f_plain_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-128F 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_128F */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[32];    /**< 公钥的明文值，32 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_128f_plain_pubkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-128F 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_128F */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 32 */
    uint8_t privkey[32];   /**< 私钥的明文值，32 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_128f_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC SLH-DSA-SHAKE-128F 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_128F */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 32 */
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t pubkey[32];    /**< 公钥的明文值，32 字节 */
    uint8_t privkey[48];   /**< 私钥的密文值，有 PKCS7 填充，48 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_128f_cipher_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-128F 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_128F */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t privkey[48];   /**< 私钥的密文值，有 PKCS7 填充，48 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_128f_cipher_privkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-128F 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_128F */
    ...
    uint8_t pubkey[32];    /**< 公钥的明文值，32 字节 */
    uint8_t privkey[32];   /**< 私钥的明文值，32 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_128f_plain_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-128F 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_128F */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[32];    /**< 公钥的明文值，32 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_128f_plain_pubkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-128F 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_128F */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 32 */
    uint8_t privkey[32];   /**< 私钥的明文值，32 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_128f_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC SLH-DSA-SHA2-192S 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_192S */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 48 */
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t pubkey[48];    /**< 公钥的明文值，48 字节 */
    uint8_t privkey[64];   /**< 私钥的密文值，有 PKCS7 填充，64 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_192s_cipher_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-192S 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_192S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t privkey[64];   /**< 私钥的密文值，有 PKCS7 填充，64 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_192s_cipher_privkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-192S 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_192S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t pubkey[48];    /**< 公钥的明文值，48 字节 */
    uint8_t privkey[48];   /**< 私钥的明文值，48 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_192s_plain_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-192S 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_192S */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[48];    /**< 公钥的明文值，48 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_192s_plain_pubkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-192S 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_192S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t privkey[48];   /**< 私钥的明文值，48 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_192s_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC SLH-DSA-SHAKE-192S 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_192S */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 48 */
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t pubkey[48];    /**< 公钥的明文值，48 字节 */
    uint8_t privkey[64];   /**< 私钥的密文值，有 PKCS7 填充，64 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_192s_cipher_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-192S 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_192S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t privkey[64];   /**< 私钥的密文值，有 PKCS7 填充，64 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_192s_cipher_privkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-192S 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_192S */
    ...
    uint8_t pubkey[48];    /**< 公钥的明文值，48 字节 */
    uint8_t privkey[48];   /**< 私钥的明文值，48 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_192s_plain_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-192S 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_192S */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[48];    /**< 公钥的明文值，48 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_192s_plain_pubkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-192S 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_192S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t privkey[48];   /**< 私钥的明文值，48 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_192s_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC SLH-DSA-SHA2-192F 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_192F */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 48 */
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t pubkey[48];    /**< 公钥的明文值，48 字节 */
    uint8_t privkey[64];   /**< 私钥的密文值，有 PKCS7 填充，64 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_192f_cipher_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-192F 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_192F */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t privkey[64];   /**< 私钥的密文值，有 PKCS7 填充，64 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_192f_cipher_privkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-192F 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_192F */
    ...
    uint8_t pubkey[48];    /**< 公钥的明文值，48 字节 */
    uint8_t privkey[48];   /**< 私钥的明文值，48 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_192f_plain_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-192F 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_192F */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[48];    /**< 公钥的明文值，48 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_192f_plain_pubkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-192F 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_192F */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t privkey[48];   /**< 私钥的明文值，48 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_192f_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC SLH-DSA-SHAKE-192F 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_192F */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 48 */
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t pubkey[48];    /**< 公钥的明文值，48 字节 */
    uint8_t privkey[64];   /**< 私钥的密文值，有 PKCS7 填充，64 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_192f_cipher_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-192F 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_192F */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t privkey[64];   /**< 私钥的密文值，有 PKCS7 填充，64 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_192f_cipher_privkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-192F 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_192F */
    ...
    uint8_t pubkey[48];    /**< 公钥的明文值，48 字节 */
    uint8_t privkey[48];   /**< 私钥的明文值，48 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_192f_plain_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-192F 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_192F */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[48];    /**< 公钥的明文值，48 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_192f_plain_pubkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-192F 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_192F */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 48 */
    uint8_t privkey[48];   /**< 私钥的明文值，48 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_192f_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC SLH-DSA-SHA2-256S 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_256S */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 64 */
    uint16_t privkey_size; /**< 私钥长度，应为 80 */
    uint8_t pubkey[64];    /**< 公钥的明文值，64 字节 */
    uint8_t privkey[80];   /**< 私钥的密文值，有 PKCS7 填充，80 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_256s_cipher_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-256S 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_256S */
    ...
    uint16_t pubkey_size;  /**< 为 0 */
    uint16_t privkey_size; /**< 私钥长度，应为 80 */
    uint8_t privkey[80];   /**< 私钥的密文值，有 PKCS7 80 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_256s_cipher_privkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-256S 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_256S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t pubkey[64];    /**< 公钥的明文值，64 字节 */
    uint8_t privkey[64];   /**< 私钥的明文值，64 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_256s_plain_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-256S 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_256S */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[64];    /**< 公钥的明文值，64 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_256s_plain_pubkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-256S 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_256S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t privkey[64];   /**< 私钥的明文值，64 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_256s_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC SLH-DSA-SHAKE-256S 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_256S */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 64 */
    uint16_t privkey_size; /**< 私钥长度，应为 80 */
    uint8_t pubkey[64];    /**< 公钥的明文值，64 字节 */
    uint8_t privkey[80];   /**< 私钥的密文值，有 PKCS7 填充，80 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_256s_cipher_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-256S 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_256S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 80 */
    uint8_t privkey[80];   /**< 私钥的密文值，有 PKCS7 填充，80 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_256s_cipher_privkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-256S 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_256S */
    ...
    uint8_t pubkey[64];    /**< 公钥的明文值，64 字节 */
    uint8_t privkey[64];   /**< 私钥的明文值，64 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_256s_plain_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-256S 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_256S */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[64];    /**< 公钥的明文值，64 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_256s_plain_pubkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-256S 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_256S */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t privkey[64];   /**< 私钥的明文值，64 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_256s_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC SLH-DSA-SHA2-256F 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_256F */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 64 */
    uint16_t privkey_size; /**< 私钥长度，应为 80 */
    uint8_t pubkey[64];    /**< 公钥的明文值，64 字节 */
    uint8_t privkey[80];   /**< 私钥的密文值，有 PKCS7 填充，80 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_256f_cipher_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-256F 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_256F */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 80 */
    uint8_t privkey[80];   /**< 私钥的密文值，有 PKCS7 填充，80 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_256f_cipher_privkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-256F 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_256F */
    ...
    uint8_t pubkey[64];    /**< 公钥的明文值，64 字节 */
    uint8_t privkey[64];   /**< 私钥的明文值，64 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_256f_plain_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-256F 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_256F */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[64];    /**< 公钥的明文值，64 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_256f_plain_pubkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHA2-256F 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHA2_256F */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t privkey[64];   /**< 私钥的明文值，64 字节 */
} ehsm_key_format_pqc_slh_dsa_sha2_256f_plain_privkey_key_st;

/**
 * @brief 用于辅助 PQC SLH-DSA-SHAKE-256F 密钥对密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_256F */
    uint8_t part_info;     /**< 应当设置为 @ref EHSM_KEY_PART_KEY_PAIR */
    uint8_t reserved[2];   /**< 保留 */
    uint16_t pubkey_size;  /**< 公钥长度，应为 64 */
    uint16_t privkey_size; /**< 私钥长度，应为 80 */
    uint8_t pubkey[64];    /**< 公钥的明文值，64 字节 */
    uint8_t privkey[80];   /**< 私钥的密文值，有 PKCS7 填充，80 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_256f_cipher_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-256F 私钥密文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_256F */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 80 */
    uint8_t privkey[80];   /**< 私钥的密文值，有 PKCS7 填充，80 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_256f_cipher_privkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-256F 密钥对明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_256F */
    ...
    uint8_t pubkey[64];    /**< 公钥的明文值，64 字节 */
    uint8_t privkey[64];   /**< 私钥的明文值，64 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_256f_plain_keypair_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-256F 公钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_256F */
    ...
    uint16_t privkey_size; /**< 为 0 */
    uint8_t pubkey[64];    /**< 公钥的明文值，64 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_256f_plain_pubkey_key_st;

/**
 * @brief 用于辅助 SLH-DSA-SHAKE-256F 私钥明文导入/导出的结构体。
 */
typedef struct {
    uint32_t privilege;    /**< 权限位，见 @ref key-priv */
    uint8_t key_type;      /**< 密钥类型，应当设置为 @ref EHSM_KEY_TYPE_PQC_SLH_DSA_SHAKE_256F */
    ...
    uint16_t privkey_size; /**< 私钥长度，应为 64 */
    uint8_t privkey[64];   /**< 私钥的明文值，64 字节 */
} ehsm_key_format_pqc_slh_dsa_shake_256f_plain_privkey_key_st;
// #% #endif /* CONFIG_EHSM_ALGO_PQC_ENABLE */

...
__Vectors       DCD     __initial_sp              ; Top of Stack
                ...
                DCD     MAILBOX_0_Handler         ; MAILBOX 0 Handler
                DCD     MAILBOX_1_Handler         ; MAILBOX 1 Handler
                DCD     MAILBOX_2_Handler         ; MAILBOX 2 Handler
                DCD     MAILBOX_3_Handler         ; MAILBOX 3 Handler
                DCD     MAILBOX_4_Handler         ; MAILBOX 4 Handler
                DCD     MAILBOX_5_Handler         ; MAILBOX 5 Handler
                DCD     MAILBOX_6_Handler         ; MAILBOX 6 Handler
                DCD     MAILBOX_7_Handler         ; MAILBOX 7 Handler
                DCD     MAILBOX_8_Handler         ; MAILBOX 8 Handler
                DCD     MAILBOX_9_Handler         ; MAILBOX 9 Handler
                DCD     MAILBOX_10_Handler        ; MAILBOX 10 Handler
                DCD     MAILBOX_11_Handler        ; MAILBOX 11 Handler
                DCD     MAILBOX_12_Handler        ; MAILBOX 12 Handler
                DCD     MAILBOX_13_Handler        ; MAILBOX 13 Handler
                DCD     MAILBOX_14_Handler        ; MAILBOX 14 Handler
                DCD     MAILBOX_15_Handler        ; MAILBOX 15 Handler
...
Default_Handler PROC
                ...
                EXPORT MAILBOX_0_Handler          [WEAK]
                EXPORT MAILBOX_1_Handler          [WEAK]
                EXPORT MAILBOX_2_Handler          [WEAK]
                EXPORT MAILBOX_3_Handler          [WEAK]
                EXPORT MAILBOX_4_Handler          [WEAK]
                EXPORT MAILBOX_5_Handler          [WEAK]
                EXPORT MAILBOX_6_Handler          [WEAK]
                EXPORT MAILBOX_7_Handler          [WEAK]
                EXPORT MAILBOX_8_Handler          [WEAK]
                EXPORT MAILBOX_9_Handler          [WEAK]
                EXPORT MAILBOX_10_Handler         [WEAK]
                EXPORT MAILBOX_11_Handler         [WEAK]
                EXPORT MAILBOX_12_Handler         [WEAK]
                EXPORT MAILBOX_13_Handler         [WEAK]
                EXPORT MAILBOX_14_Handler         [WEAK]
                EXPORT MAILBOX_15_Handler         [WEAK]

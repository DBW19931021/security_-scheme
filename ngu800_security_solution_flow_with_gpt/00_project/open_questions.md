...
| OQ-0009 | Recovery image 独立策略 | Boot / Recovery / RMA | Security Owner | `[OPEN]` | 冻结 recovery image 的 image_type、signer、trust anchor、rollback counter、decrypt policy 和 measurement/audit 表达 |
